                                                ...
                                                <ul class="list-reset text-950 font-semibold">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('user.applications') }}"
                                                            class="hover:text-yell px-4 py-2 flex md:w-full items-start hover:bg-gray-100 no-underline hover:no-underline transition-colors duration-100 cursor-pointer">
                                                            <span class="flex-1">Applications</span> </a>
                                                    </li>
                                                    <li>
                                ...
                                <div class="flex items-center justify-end">
                                    <div class="ml-3">
                                        <form action="{{ route('logout') }}" method="POST">
                                            @csrf 
                                            <button  type="submit"  class="inline-flex items-center gap-2 px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-yell hover:bg-primary-2 focus:outline-none focus:border-primary-3 focus:shadow-outline-primary active:bg-primary-3 transition ease-in-out duration-150">Logout
