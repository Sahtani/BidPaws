...
<body class="bg-white">
                ...
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <div class="flex flex-row gap-1 items-center justify-center md:ml-16">
                        <div class="toggle-menu flex items-center justify-center">
                            <a href="#">
                                <img src="{{ asset('image/go.png') }}" width="70" height="70" alt="Flowbite Logo" />
                            </a>
                        </div>
                    </div>
    ...
    <aside id="logo-sidebar"
        class="bg-verblanc fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar">
