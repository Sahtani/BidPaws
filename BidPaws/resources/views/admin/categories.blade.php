...
<div class=" mx-20 px-4 py-8 sm:px-8 sm:ml-64 bg-white w-full h-16 flex ">
    ...
    @if (session('success'))
        <div class="w-full ml-64">
            <div class="flex items-center p-4  w-1/3 p-4 ml-12 mt-4 text-xl text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
                role="alert">
    ...
    @if (session('error'))
        <div class="w-full ml-64"">
            <div class="flex items-center p-4 w-full  ml-12 mt-4 text-xl text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-blue-400"
                role="alert">
                <svg class="flex-shrink-0 inline w-4 h-4 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor" viewBox="0 0 20 20">
                    <path
    ...
    <div class='p-4 sm:ml-6'>
        <div class="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 px-4 pb-8 items-start p-4 sm:ml-64">
            <div class=" bg-yell rounded flex-no-shrink w-70  p-2 my-4 mx-3 shadow-xl hover:shadow-2xl">
                <div class="relative flex flex-col items-start my-4 mt-3 rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100 "
                    draggable="true">
                    <div class="p-4">
                        <button data-modal-target="crud" onclick="clickBuyBtn(event)" data-modal-toggle="crud"
                            class="font-semibold bg-yell text-gray-100 rounded flex items-center justify-center h-full focus:outline-none ">
                    ...
                    <div class="relative flex flex-col items-start p-4 mt-3 bg-white rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100 shadow-xl hover:shadow-2xl"
                        ...
                        <div class="flex items-center w-full justify-between mt-3 text-xs font-medium text-gray-400">
                            ...
                            <div class="flex items-center justify-end ">
                                ...
                                <a title="Edit" id="editCategorieButton" data-modal-target="crud-modal"
                                    data-modal-toggle="crud-modal" data-categorie-id="{{ $cat->id }}"
                                    data-categorie-name="{{ $cat->name }}">
    ...
    <!-- add -->
    <div id="crud" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <form class=" addcat p-4 md:p-5" action="{{ route('admin.storecat') }}" method="post">
                    ...
                    <div class="flex items-center justify-center">
                        <button name="submit-add" type="submit" id="submitButton"
                            class="text-white inline-flex items-center bg-red-800 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:hover:bg-moinmaron">
                            Add
                        </button>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <form class="p-4 md:p-5" action="{{ route('admin.update') }}" method="post">
                    ...
                    <div class="flex items-center justify-center">
                        <button name="submit-edite" type="submit"
                            class="text-white inline-flex items-center bg-red-800  focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:hover:bg-moinmaron">
                            Update
                        </button>
                    </div>
