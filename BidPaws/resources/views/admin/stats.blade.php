        ...
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 mt-10">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
                ...
                <div class="px-4 py-4    shadow-lg shadow-blue-100 bg-white">
                    ...
                    <p class="mt-4 font-medium">Requests accepted </p>
                    <p class="mt-2 text-xl font-medium">
                ...
                <div class="px-4 py-4    shadow-lg shadow-blue-100 bg-white">
                    ...
                    <p class="mt-4 font-medium">Applications refused  </p>
                    <p class="mt-2 text-xl font-medium">
                ...
                <div class="px-4 py-4    shadow-lg shadow-blue-100 bg-white">
                    ...
                    <p class="mt-4 font-medium">Pending requests </p>
                    <p class="mt-2 text-xl font-medium">
                ...
                <div class="px-4 py-4    shadow-lg shadow-blue-100 bg-white">
                    ...
                    <p class="mt-4 font-medium">Users not banned</p>
                    <p class="mt-2 text-xl font-medium">
                        {{ $stats['usernotBand'] }} 
                    </p>
                </div>
