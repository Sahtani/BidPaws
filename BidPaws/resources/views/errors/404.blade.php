...
<body class="bg-gray-200 font-[sans-serif]">
    ...
    <x-nav />
    <section>
        <div class="not-found-page mx-auto">
            <div class="not-found-container">
                <div class="not-found-wrapper flex items-center justify-center ">
                    <div class="not-found-assets-element">
                        <img src="{{ asset('image/404.png') }}" width="400px" />
                    </div>
                </div>
            </div>
        </div>
