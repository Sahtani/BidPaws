                            ...
                            <tr>
                                @foreach ($applications as $application)
                                    ...
                                    <td class="border-b border-gray-200 bg-white px- py-5 text-sm">
                                        ...
                                        @else
                                            <span
                                                class="rounded-full bg-red-200 px-3 py-1 text-xs font-semibold text-red-900">Accepted</span>
                                        @endif
                                    ...
                                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                        <form method="POST" action="{{ route('user.validaterequest',$application->id) }}">
                                            ...
                                            @else
                                                <button
                                                    type="submit"class="rounded-full bg-green-200 px-3 py-1 text-xs font-semibold text-green-900">Refuse</button>
                                            @endif
                                        </form>
                                    </td>
                            </tr>
