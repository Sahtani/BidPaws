                ...
                <div class="tab-content">
                    <div id="signup">
                        <form action="/" method="post">
                            ...
                            <div class="flex items-center border-2 py-2 px-3  mb-4">
                                ...
                                <input class="pl-2 outline-none border-none w-full" type="text" name="" id=""
                    ...
                    <div id="login">
                        ...
                        <form action="/" method="post">
                            ...
                            <button type="submit" class="block w-full bg-950 mt-4 py-2  text-white font-semibold mb-2">Log
                              In</button>
