                    ...
                    <div id="signup-form">
                        <form action="{{ route('register') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="flex items-center border-2 py-2 px-3 mb-4">
                                ...
                                <input class="pl-2 outline-none border-none w-full" type="text" name="username" value="{{ old('username') }}"
                            ...
                            <div class="flex items-center border-2 py-2 px-3  mb-4">
                                ...
                                <input class="pl-2 outline-none border-none w-full" type="text" name="email" value="{{ old('email') }}"
                            ...
                            <div class="flex items-center border-2 py-2 px-3 ">
                                ...
                                <input class="pl-2 outline-none border-none w-full" type="password" name="password" value="{{ old('password') }}"
